...
<cms:template title='ADH-PAL page' />
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-16">
          ...
          <div class="card mb-4">
            <div class="card-body">
              <h2 class="card-title">Academic Discussion Hours</h2>
              <cms:editable name='adh' type='richtext'>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <h2 class="card-title">Peer-Assisted Learning</h2>
              <cms:editable name='pal' type='richtext'>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>
              </cms:editable>
            </div>
            <div class="card-footer text-muted">
